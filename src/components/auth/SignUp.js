...
export const SignUp = () => {
	return (
		<div className="container-fluid">
			...
			<div className="col-lg-3 d-flex align-items-end" id="bg-block" style={{ backgroundImage: `url(${Banner})`, backgroundSize: '72%', backgroundPosition: 'center center' }} />
				<div id="register-block" className="col-10 col-sm-8 col-md-6 col-lg-8 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0">
